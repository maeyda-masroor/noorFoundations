...
function NFSForm(){
        ...
        return (
            <div class="container"><h1>Noor Health Care and Education scholarship Form for Employee Themselves</h1>
        <br/>
        ...
        <div class="rounded h-100 d-flex align-items-center p-5" style={{backgroundColor:'#d7ab3c'}}>
            <div class="row g-3">
                ...
                <div class="col-12 col-sm-6">
                    <label for="Employee Email:" style={{color:'white'}}>Employee Email</label>
                ...
                <input type="text" class="form-control border-0" placeholder="Employee Code" propsstyle="height: 55px;" onChange={(e) => setEmployeeCode(e.target.value)}
                {...register("code", {
                    required: true,
                    pattern:/^\941|^[234]\d{3}$/
                ...
                <div class="col-12 col-sm-6">
                    ...
                    <select onChange={(e)=>{setPresentOrEx(e.target.value)}} value={PresentOrExEmployee} required>
                ...
                <div class="col-12 col-sm-6">
                  ...
                  <input  type="text" class="form-control border-0" placeholder="Employee Father / Husband Name" onChange={(e)=>{
                ...
                <textarea type="text" class="form-control border-0" placeholder="Details of Already availed scholarships from PILL {If any}:" propsstyle="height: 55px;" onChange={(e) => setdetailofScholarshipPill(e.target.value)}></textarea>
                </div>
                <div class ="col-12 col-sm-6">
                ...
                <input type="text" class="form-control border-0" placeholder="Monthly income" propsstyle="height: 55px;" onChange={(e) => setMonthlyIncome(e.target.value)}/>
                </div>
                <div class = "col-12 col-sm-6">
                ...
                <div class="col-12 col-sm-6">
                    ...
                    <textarea type = "text" class="form-control border-0" rows="5" placeholder="Details of Family Member" onChange={e=>{setdetailoffamilymember(e.target.value)}}
                  ></textarea>
                </div>
                <div class="col-12 col-sm-6">
                    <label for = "" style={{color:'white'}}>residence own rented</label>
                    <input type = "text" class="form-control border-0" rows="5" placeholder="House Own or Rented" onChange={(e)=>setresidenceown_rented(e.target.value)}
                    name="presentOrEx"
                    />
                </div>
                <div class="col-12 col-sm-6">
